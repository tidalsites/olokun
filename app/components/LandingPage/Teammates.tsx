...
import seaportnxg from "@/public/teammates/seaportnxg.webp";
...
export const Teammates = () => {
  return (
    <section className="bg-zinc-200 text-zinc-800 text-center py-20 border-b-2 border-b-black border-t-2 border-t-black px-8">
      ...
      <p className="max-w-prose mx-auto mb-8 md:mb-20">
      ...
      <div className="grid grid-cols-auto grid-rows-[repeat(auto-fit,minmax(150px,1fr))] gap-2 md:gap-8">
        <div className="bg-zinc-300 p-4 md:p-8 rounded-lg grid place-content-center">
          <Image
            src={avmac}
            alt="Avmac LLC"
        ...
        <div className="bg-zinc-300 p-4 md:p-8 rounded-lg grid place-content-center w-full">
          <Image
            src={avatara}
            alt="Avatara"
            className="max-h-12 md:max-h-16 w-auto"
        ...
        <div className="bg-zinc-300 p-4 md:p-8 rounded-lg grid place-content-center">
          <Image src={vtg} alt="VTG" className="max-h-12 md:max-h-16 w-auto" />
        </div>
        <div className="bg-zinc-300 p-4 md:p-8 rounded-lg grid place-content-center">
          <Image
            src={saria}
